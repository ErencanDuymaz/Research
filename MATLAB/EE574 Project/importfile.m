function UW = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   UW = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   UW = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   UW = importfile('ieee_cdf.dat',6, 6);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/12/12 01:22:29
