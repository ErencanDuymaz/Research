...
\begin{figure}[h!]
	...
	\label{powerdata}
\end{figure}
The wind turbine properties used in this study belong to GE2.75-103 model. Fig. \ref{bares} shows the wind turbine from a wind farm in Balıkesir. The properties of the GE2.75-103 is listed in Table \ref{ge275}.
\begin{figure}[h!]
	\centering
	\includegraphics[width=.9\linewidth]{bares.jpg}
