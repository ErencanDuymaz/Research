...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.85\linewidth]{increaseinpower.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.85\linewidth]{pdf_wind.pdf}
...
\end{figure}
\newpage
Since Fig. \ref{net_contribution} is basically product of the pdf given in Fig. \ref{windpdf} and increase in the active power given with green line in Fig. \ref{increase_active_power}, the graph shows the average contribution from a defined wind speed by considering its probability and active power increase value. Therefore, it can be concluded that the average contribution of wind turbine can be found by calculating the area under the Fig. \ref{net_contribution}. In this study, average 0.3pu active power increase is found according to the wind speed measurements.\par
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{lowpowers2.png}
...
\end{figure}
 Generator speed decreases due to increased generator power while the turbine power is almost constant. Since the turbine leaves the MPP point, the turbine power declines. However, the change in the turbine power is small. 
