...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{high_power_speed_2.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1 \linewidth]{high_torques_speed.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{s20_22.png}
