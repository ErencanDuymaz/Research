...
The fast inertial support is independent of the grid frequency. However, the increase in the active power can be a function of the frequency behaviour as in the case of synthetic inertia. In the Chapter \ref{chp:5}, the inertial support proportional to RoCoF will be investigated. 