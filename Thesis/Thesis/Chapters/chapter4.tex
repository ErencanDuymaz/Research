...
The modified base is very similar to the Base Case except for a wind farm located in Bus 5. The renewable energy system in this case can be considered as a negative load. Therefore, base case with decreased load is under discussion in this subsection. The same amount of load is taken into operation at Bus 6 and the frequency of the system is shown in Figure \ref{Case1_2_freq}.\\
\begin{figure}[h!]
	\centering
...
Same amount of additional load is taken into operation from Bus 6. System frequency response is observed and compared to Base Case and Modified Case in Figure \ref{Case1_2_3_freq}. As soon from the figure, the frequency nadir decreased from 49.77Hz to 49.65Hz. This is due to the decrease in the stored kinetic energy in the system. Due to the decommission of generator 3, the frequency decreases steeper following to load connection.This can also be observed RoCoF comparison given in Figure \ref{Case1_2_3_rocof}. 
\begin{figure}[h!]
	\centering
